<!-- start: right menu -->
                ...
                <div id="right-menu-user" class="tab-pane fade in active">
                  ...
                  <div class="user col-md-12">
                   <ul class="nav nav-list">
                    <li class="online">
                      <img src="<?=base_url()?>assets_miminium/img/avatar.jpg" alt="user name">
                      <div class="name">
                        ...
                        <div class="row msg_container send">
                          <div class="col-md-9 col-xs-9 bubble">
                            ...
                            <div class="col-md-3 col-xs-3 avatar">
                              <img src="<?=base_url()?>assets_miminium/img/avatar.jpg" class=" img-responsive " alt="user name">
                            </div>
                          </div>
                                ...
                                <ul>
                                  <li class="online">
                                    <a href=""  data-toggle="tooltip" data-placement="left" title="Akihiko avaron">
                                      <div class="user-avatar"><img src="<?=base_url()?>assets_miminium/img/avatar.jpg" alt="user name"></div>
                                      <div class="dot"></div>
                                    </a>
                                  </li>
                                  <li class="offline">
    ...
    <script src="<?=base_url()?>asset_miminium/js/plugins/fullcalendar.min.js"></script>
    <script src="<?=base_url()?>assets_miminium/js/plugins/jquery.nicescroll.js"></script>
    <script src="<?=base_url()?>assets_miminium/js/plugins/jquery.vmap.min.js"></script>
    <script src="<?=base_url()?>assets_miminium/js/plugins/maps/jquery.vmap.world.js"></script>
    <script src="<?=base_url()?>assets_miminium/js/plugins/jquery.vmap.sampledata.js"></script>
    <script src="<?=base_url()?>assets_miminium/js/plugins/chart.min.js"></script>


    <!-- custom -->
     <script src="<?=base_url()?>assets_miminium/js/main.js"></script>
