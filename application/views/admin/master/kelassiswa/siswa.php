			...
			<div class="panel-heading bg-white border-none" style="padding:20px;">
				<div class="row">
					...
					<div class="col-md-6 text-right">
						<a href="<?= site_url('Admin/Kelassiswa/Index/create/') . $kelas->id ?>" class="btn btn-primary mb-3"> <i class="fa fa-plus"></i> Tambah Siswa ke Kelas</a>
						<a href="<?= site_url('Admin/Kelassiswa/Index') ?>" class="btn btn-secondary mb-3"> <i class="fa fa-arrow-left"></i> Kembali</a>
					</div>
				</div>
			</div>
