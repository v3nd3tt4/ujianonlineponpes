        ...
        <div class="panel">
            <div class="panel-heading bg-white border-none" style="padding:20px;">
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        <a href="<?= site_url('Admin/Ruangan/Index/create') ?>" class="btn btn-primary mb-3"> <i class="fa fa-plus"></i> Tambah Ruangan</a>
                    </div>
                </div>
            </div>
            <div class="panel-body" style="padding-bottom:50px;">
                ...
                <table class="table table-bordered dt-table">
                    ...
                    <tbody>
                        <?php $no = 1; foreach ($ruangan as $row): ?>
                            <tr>
                                <td><?= $no++; ?></td>
                                <td><?= htmlspecialchars($row->nama_ruangan); ?></td>
                                <td><?= htmlspecialchars($row->keterangan); ?></td>
                                <td>
                                    <a href="<?= site_url('Admin/Ruangan/Index/edit/' . $row->id) ?>" class="btn btn-warning btn-sm">Edit</a>
