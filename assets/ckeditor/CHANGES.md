...
* [#12279](http://dev.ckeditor.com/ticket/12279): Added a possibility to pass a custom approver to [`node.getAscendant()`](http://docs.ckeditor.com/#!/api/CKEDITOR.dom.node-method-getAscendant).
